...
5. `node .ai/scripts/modules/integrationctl.mjs validate`
6. `node .ai/scripts/modules/integrationctl.mjs compile`
7. `node .ai/scripts/modules/integrationctl.mjs run --scenario <id>` (when runtime endpoints are configured)
