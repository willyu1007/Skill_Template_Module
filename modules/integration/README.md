...
5. `node .ai/scripts/modules/ctl-integration.mjs validate`
6. `node .ai/scripts/modules/ctl-integration.mjs compile`
7. `node .ai/scripts/modules/ctl-integration.mjs run --scenario <id>` (when runtime endpoints are configured)
