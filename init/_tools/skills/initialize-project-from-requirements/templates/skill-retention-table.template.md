...
Use this template after Stage C to summarize available skills. This file should live at `init/_work/skill-retention-table.template.md` (legacy: `init/skill-retention-table.template.md`).
