...
- AI MUST use `node .ai/skills/features/database/sync-code-schema-from-db/scripts/dbctl.mjs` and `node .ai/skills/features/database/sync-code-schema-from-db/scripts/migrate.mjs` for all database operations.
...
3. **Generate** migrations: `node .ai/skills/features/database/sync-code-schema-from-db/scripts/dbctl.mjs generate-migration --name <name>`
