...
The Project Contract is the **single source of truth** for the repository's project progress governance system.
...
project:
  task_doc_roots:
    - modules/some-module/dev-docs
    - modules/integration/dev-docs
```
