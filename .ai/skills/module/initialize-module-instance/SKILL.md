...
description: Create a new module instance with modulectl, including a dev-docs baseline, and register the module into the modular SSOT/derived registries.
---
...
Important: `modulectl init --apply` already creates a basic `AGENTS.md` with Operating Rules and Key Files. The documentation confirmation step enhances that file by adding boundary definitions, not replacing the generated file.
