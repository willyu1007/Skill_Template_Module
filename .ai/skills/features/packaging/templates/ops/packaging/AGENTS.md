...
- Use `ctl-pack.mjs` to manage packaging configuration.
...
1. **Register** targets: `node .ai/skills/features/packaging/scripts/ctl-pack.mjs add-service --id <id> --module <path>`
