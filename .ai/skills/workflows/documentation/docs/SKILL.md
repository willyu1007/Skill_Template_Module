---
name: docs
description: Router skill for documentation work: author developer docs, create a dev-docs task bundle, or update dev-docs for handoff/archival with progressive disclosure.
---
...
| Create or resume a dev-docs task bundle (00-05) | `create-dev-docs-plan` |
| Finalize dev-docs for handoff or wrap-up | `update-dev-docs-for-handoff` |

## Shared non-negotiables

1) Progressive disclosure
   - Keep top-level docs short; move deep detail into module/integration dev-docs (`modules/<module_id>/dev-docs/`, `modules/integration/dev-docs/`) or the selected workflow skill’s supporting folders (reference, examples, templates) when present.
...
1. Identify whether the intent is: (a) write docs, (b) start a dev-docs task bundle, or (c) handoff/update.
