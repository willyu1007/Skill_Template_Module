...
| Create or resume a workdocs task bundle (00–05) | `create-workdocs-plan` |
| Finalize workdocs for handoff or wrap-up | `update-workdocs-for-handoff` |

## Shared non-negotiables
1) **Progressive disclosure**
   - Keep top-level docs short; move deep detail into module/integration workdocs (`modules/<module_id>/workdocs/`, `modules/integration/workdocs/`) or the selected workflow skill’s supporting folders (reference, examples, templates) when present.
...
## Steps
1. Identify whether the intent is: (a) write docs, (b) start a workdocs task bundle, or (c) handoff/update.
